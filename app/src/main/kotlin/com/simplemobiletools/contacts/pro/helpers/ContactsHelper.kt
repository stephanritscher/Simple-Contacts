        ...
        try {
            ...
            contact.addresses.forEach {
                ContentProviderOperation.newInsert(Data.CONTENT_URI).apply {
                    ...
                    withValue(StructuredPostal.COUNTRY, it.country)
                    withValue(StructuredPostal.REGION, it.region)
                    withValue(StructuredPostal.CITY, it.city)
                    withValue(StructuredPostal.POSTCODE, it.postcode)
                    withValue(StructuredPostal.POBOX, it.pobox)
                    withValue(StructuredPostal.STREET, it.street)
                    withValue(StructuredPostal.NEIGHBORHOOD, it.neighborhood)
